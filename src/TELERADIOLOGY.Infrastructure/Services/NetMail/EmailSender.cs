...
namespace TELERADIOLOGY.Infrastructure.Services.NetMail
{
    public class EmailSender : IEmailSender
    {
        ...
        {
            Execute(email, subject, message, new List<Attachment>()).Wait();
        ...
        {
            Execute(email, subject, message, attachments ?? new List<Attachment>()).Wait();
